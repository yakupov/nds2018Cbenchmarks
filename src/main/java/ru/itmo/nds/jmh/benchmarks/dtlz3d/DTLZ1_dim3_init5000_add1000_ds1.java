 ...
 */
public class DTLZ1_dim3_init5000_add1000_ds1 extends AbstractDtlzZdtBenchmark {
    @Override
    protected DoublesAdditionProblem loadAdditionProblem() throws Exception {
        try (InputStream is = DTLZ1_dim3_init5000_add1000_ds1.class
                .getResourceAsStream("dtlz1_dim3_initSize5000_addendsCount1000_dataset1.json")) {
