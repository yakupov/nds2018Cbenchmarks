...
abstract public class AbstractDTLZNDBenchmark extends AbstractDtlzZdtBenchmark {
    ...
    protected DoublesAdditionProblem loadAdditionProblem() throws Exception {
        try (InputStream is = AbstractDTLZNDBenchmark.class.getResourceAsStream(generateTestFileName())) {
